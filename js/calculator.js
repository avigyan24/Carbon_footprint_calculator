...
function addData() {
    ...
    var tweetValue = `The average  citizen makes a carbon footprint of ${usAverageCo2} kgCO2eq per day. I made a carbon footprint of ${parseFloat(co2).toFixed(3)} kgCO2eq today, which is ${difference}% ${greaterOrLesser} than the average US citizen`;
